...
| Tests                                                        | `./test/*`                                        | We use **Jest** with **Enzime** to test our code.            |
...
| Test a React Widget                                          | `ConfirmDialog.test.tsx`                          | We simulate a click on a dialog using Enzime API. We also use **snapshots** to test what is rendered. |
...
| Enzime and React 17                                          | `./test/common/setup.ts`                          | Enzime adapter support only React 16. So we don't use React 17 for now. |
